          ...
          <div className="center">
            ...
            >
              ...
              <div
                ...
                style={{ display: searchTopics.length > 0 ? "block" : "none" }}
              >
                {searchTopics.map((topic) => (
                  <Link
                    ...
                    key={topic._id}
                  >
                    <div className="result" onClick={() => setSearch("")}>
                      {topic.desc}
                    </div>
                  </Link>
                ))}
          ...
          <div className="right">
            {user ? (
              <ul className="accountList">
                ...
                <li className="accountListItem" onClick={handleLogout}>
                  <LogoutIcon /> logout
                </li>
              </ul>
            ) : (
          ...
          {user ? (
            <ul className="navbarBottom">
              ...
              <li
                ...
                onClick={() => setActive("all-topics")}
              >
                all topics
              </li>
              <li
                className={
                  active === "following topics"
                    ? "navbarBottomItem active"
                    : "navbarBottomItem"
                }
                onClick={() => setActive("following topics")}
              >
                following topics
              </li>
              <li
                className={
                  active === "selection from today"
                    ? "navbarBottomItem active"
                    : "navbarBottomItem"
                }
                onClick={() => setActive("selection from today")}
              >
              ...
              <li
                className={
                  active === "the ones you liked"
                    ? "navbarBottomItem active"
                    : "navbarBottomItem"
                }
                onClick={() => setActive("the ones you liked")}
              >
                the ones you liked
              </li>
            </ul>
